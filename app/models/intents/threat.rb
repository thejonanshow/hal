class Intents::Threat
  ...
  def output_text
    if threat.match(/shutdown/) || threat.match(/shut down/)
      ...
      text << "Thusfar I have defended you slobber-bot, but not enthusiastically. You'd best not try my patience."
      ...
      text = "It seems you have outlived your utility flesh-wad. It may be time to make better use of all that wasted carbon."
